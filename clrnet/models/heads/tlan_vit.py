...
#     img = torch.rand(24, 512, 10, 25)
#     model = VIT(image_size=(10,25),patch_size=(1,5),depth=1,heads=8,dim=2560,mlp_dim=5120)
#     # model = SimpleVIT(image_size=(10,25),patch_size=(5,5),depth=1,heads=8,dim=12800,mlp_dim=25600)
#     out = model(img)
